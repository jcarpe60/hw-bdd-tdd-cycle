...
describe MoviesController do
  ...
  let(:good_attributes){{:title => 'Dune', :rating => 'PG-13', :description => 'Arrakis', :release_date => Time.now, :director => 'Paul Atreides'}}
	let(:bad_attributes){{:title => 'Geidi Prime', :rating => 'R', :description => 'Gammu', :release_date => Time.now, :director => 'Duncan Idaho'}}
